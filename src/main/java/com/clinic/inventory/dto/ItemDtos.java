...
public final class ItemDtos {
    ...
    public record CreateRequest(
            ...
            @Min(0) @Max(500) int reorderQuantity) {}
    ...
    public record Response(Long id, String code, String name, ItemCategory category,
                           Long unitOfMeasureId, String unitOfMeasure,
